...
lun = open(savefile, 'w')
lun.write("Year \t Julian Day \t Hour \t Minute \t \Second \t Temp1 (K) \t Temp2 (K) \t Pressure (hPa) \t RH (%) \t Wind Direction (V) \t Wind Speed (m/s) \t Rain Rate (mm/hr) \t Year \t Julian Day \t Hour \t Minute \t Second"
lun.write("\n")
lun.close()
